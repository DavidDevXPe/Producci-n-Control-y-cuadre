  ...
  return (
    ...
    >
      {lots.length === 0 ? (
        ...
        <>
          <dl className="grid gap-3 border-b border-slate-200 bg-slate-50/70 p-5 sm:grid-cols-2 sm:p-6 xl:grid-cols-4">
            {[
              ...
              <div key={String(label)} className="rounded-xl bg-white p-3 ring-1 ring-slate-200">
                ...
                <dd className="number-tabular mt-1 text-sm font-extrabold text-slate-950">
            ...
            <table className="erp-table w-full min-w-[54rem] border-collapse text-left">
              ...
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50/90 text-xs font-bold uppercase tracking-[0.08em] text-slate-500">
                  ...
                  <th scope="col" className="px-3 py-3.5 text-right">Noche</th>
                  <th scope="col" className="px-3 py-3.5 text-right">Pendiente</th>
